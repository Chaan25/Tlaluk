...
<!--start slider -->
<link rel="stylesheet" href="/public/layout/styles/fwslider.css" media="all">
<script src="/public/layout/scripts/jquery-ui.min.js"></script>
<script src="/public/layout/scripts/fwslider.js"></script>
<!--end slider -->
	...
	<!-- start slider -->
       <div id="fwslider">
         <div class="slider_container">
            <div class="slide"> 
                <!-- Slide image -->
               <img src="/public/pictures/slider1.jpg" class="img-responsive" alt=""/>
                <!-- /Slide image -->
                <!-- Texts container -->
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <!-- Text title -->
                        <h1 class="title">DRESS THE POWER</h1>
                        <!-- /Text title -->
                        <div class="button"><a href="#">Leer Más</a></div>
                    </div>
                </div>
               <!-- /Texts container -->
            </div>
            ...
            <div class="slide">
               <img src="/public/pictures/slider2.jpg" class="img-responsive" alt=""/>
                <div class="slide_content">
                    <div class="slide_content_wrap">
                        <h1 class="title">SIENTE TU ESENCIA</h1>
                       	<div class="button"><a href="#">Leer Más</a></div>
                    </div>
                </div>
			</div>
			<!-- /Duplicate to create more slides -->
            <div class="slide">
				<img src="/public/pictures/slider3.jpg" class="img-responsive" alt=""/>
				 <div class="slide_content">
					 <div class="slide_content_wrap">
						 <h1 class="title">PROYECTA TU CULTURA</h1>
							<div class="button"><a href="#">Leer Más</a></div>
					 </div>
				 </div>
			 </div>
	  ...
	  <div class="main">
		<div class="content-top">
			<h2>PRODUCTOS</h2>
			<p>VISITA NUESTRO CATÁLOGO PARA MÁS DETALLES</p>
			<div class="close_but"><i class="close1"> </i></div>
				<ul id="flexiselDemo3">
				<li><img src="/public/pictures/board1.jpg" /></li>
				<li><img src="/public/pictures/board2.jpg" /></li>
				<li><img src="/public/pictures/board3.jpg" /></li>
				<li><img src="/public/pictures/board4.jpg" /></li>
				<li><img src="/public/pictures/board5.jpg" /></li>
			</ul>
		...
		<script type="text/javascript" src="/public/layout/scripts/jquery.flexisel.js"></script>
		</div>
	</div>
			  ...
			  <div class="row">
				<div class="col-md-3 top_box">
				  <div class="view view-ninth"><a href="./single">
                    <img src="/public/pictures/pic1.jpg" class="img-responsive" alt=""/>
                ...
                <div class="col-md-3 top_box">
					<div class="view view-ninth"><a href="./single">
                    <img src="/public/pictures/pic2.jpg" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
				...
				<div class="col-md-3 top_box">
					<div class="view view-ninth"><a href="./single">
                    <img src="/public/pictures/pic3.jpg" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
				...
				<div class="col-md-3 top_box1">
					<div class="view view-ninth"><a href="./single">
                    <img src="/public/pictures/pic4.jpg" class="img-responsive" alt=""/>
                    <div class="mask mask-1"> </div>
                    <div class="mask mask-2"> </div>
                      <div class="content">
                        <h2>Hover Style #9</h2>
