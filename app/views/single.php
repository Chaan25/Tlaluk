...
<script type="text/javascript">
     ...
     <!----details-product-slider--->
				<!-- Include the Etalage files -->
					<link rel="stylesheet" href="/public/layout/styles/etalage.css">
					<script src="/public/layout/scripts/jquery.etalage.min.js"></script>
				<!-- Include the Etalage files -->
				<script>
		...
		<div class="container">
				...
				<div class="col-md-9 single_left">
				   <div class="single_image">
					     <ul id="etalage">
							<li>
								<a href="./optionallink">
									<img class="etalage_thumb_image" src="/public/pictures/3.jpg" />
									<img class="etalage_source_image" src="/public/pictures/3.jpg" />
								</a>
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/4.jpg" />
								<img class="etalage_source_image" src="/public/pictures/4.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/5.jpg" />
								<img class="etalage_source_image" src="/public/pictures/5.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/6.jpg" />
								<img class="etalage_source_image" src="/public/pictures/6.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/7.jpg" />
								<img class="etalage_source_image" src="/public/pictures/7.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/8.jpg" />
								<img class="etalage_source_image" src="/public/pictures/8.jpg" />
							</li>
							<li>
								<img class="etalage_thumb_image" src="/public/pictures/9.jpg" />
								<img class="etalage_source_image" src="/public/pictures/9.jpg" />
							</li>
						</ul>
					    </div>
				        <!-- end product_slider -->
				        <div class="single_right">
							...
							<ul class="add-to-links">
    			              <li><img src="/public/pictures/wish.png" alt=""><a href="#">Add to wishlist</a></li>
    			            </ul>
			...
			<div class="row">
				...
				<div class="col-md-4 product1">
					<img src="/public/pictures/s1.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="./single">
						</a><h3><a href="./single"></a><a href="#">aliquam volutp</a></h3>
				...
				<div class="col-md-4 product1">
					<img src="/public/pictures/s2.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="./single">
						</a><h3><a href="./single"></a><a href="#">aliquam volutp</a></h3>
						<p>Lorem ipsum consectetuer adipiscing </p>
						<span class="reducedfrom">$66.00</span>
				...
				<div class="col-md-4">
					<img src="/public/pictures/s3.jpg" class="img-responsive" alt=""/> 
					<div class="shop_desc"><a href="./single">
						</a><h3><a href="./single"></a><a href="#">aliquam volutp</a></h3>
						<p>Lorem ipsum consectetuer adipiscing </p>
						<span class="reducedfrom">$66.00</span>
